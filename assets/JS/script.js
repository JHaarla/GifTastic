$(document).ready(function(){
    ...
    var apiURLBase = "https://api.giphy.com/v1/gifs/search?api_key=" + authKey + "&limit=10&offset=" + offset + "&rating=PG-13&q=";
    ...
    // add/remove class to show the "active" button
    ...
    // $(document).on("click", "#userInputBtn", function(event) {
        ...
        event.preventDefault(); // never did get this to work properly... 
    ...
    // show more GIFs button functionality added here - adds 10 more gifs of the already chosen GIF

    $(".beforeGIF").on("click", "#moreGIF", function(){ //event delegation syntax for the on.click event to read dynamically added buttons
        // console.log(queryTerm);
        // adds 10 to the offset so the next 10 Gifs will be pulled & displayed
        offset += 10;
        var moreGifsURL = "https://api.giphy.com/v1/gifs/search?api_key=" + authKey + "&limit=10&offset=" + offset + "&rating=PG-13&q=";
        queryURL = moreGifsURL + queryTerm;
        // console.log(queryURL);
        // the ajax call and promise
        $.ajax({
            url: queryURL,
